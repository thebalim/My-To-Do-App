...
def write_todos(todos_arg, filepath="todos.txt"):  # non default parameter todos_arg should always be before default
...
if __name__ == "__main__":  # this won't allow print to run "hello" when we use main.py.
    print("hello")  # this will only run when we use functions.py
    print(get_todos())  # the __name__ changes to function when we call it on main.py
